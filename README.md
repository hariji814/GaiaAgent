...
| **Claude-native** | Agentic loop, tool-use, and dynamic decomposition out of the box |
...
| [Bridge Developer Guide](docs/architecture/bridge-guide.md) | How to write custom protocol bridges |
| [Quick Start](docs/guides/quickstart.md) | 5-minute tutorial for your first agent |
| [Workflow Patterns](docs/guides/workflows.md) | 5 orchestration patterns + Claude integration |
| [Deployment Guide](docs/guides/deployment.md) | Local, Docker, and production deployment |
...
- 📝 **Protocol changes** — require an [AURC-RFC](CONTRIBUTING.md#protocol-changes--协议变更)
